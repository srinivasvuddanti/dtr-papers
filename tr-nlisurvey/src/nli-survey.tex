...
\raisebox{.5pt}{\textcircled{\raisebox{-.9pt} {1}}} to
...
Table~\ref{tab:overview} presents an overview of major systems that we take into
...
& {\sc Qwerty}~\cite{Nelken:2000:QTD:992730.992808} & & temporal & & - & &
\\\cline{2-8} & {\sc
...
{\sc Masque/SQL}~\cite{Androutsopoulos93masque} & & Prolog/SQL & & + & &
\\\cline{2-8} & {\sc Team}~\cite{Grosz:1987:TED:25672.25674} & & & & + & & + \\\cline{2-8}
